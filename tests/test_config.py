...
def test_load_config_with_all_values(monkeypatch):
    ...
    monkeypatch.setenv("CATEGORY_PAUSE_TIME", "5")
    ...
    assert cfg["category_pause_time"] == 5
...
def test_load_config_defaults(mock_dotenv, monkeypatch):
    ...
    monkeypatch.delenv("CATEGORY_PAUSE_TIME", raising=False)
    ...
    assert cfg["category_pause_time"] == 3
